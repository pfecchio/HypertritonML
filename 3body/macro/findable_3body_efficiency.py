...
input_file = TFile('~/3body_workspace/preseleff_study/selector_output.root', 'read')

hist_genA = input_file.Get('fHistGen_A')
hist_genA.SetDirectory(0)
hist_genM = input_file.Get('fHistGen_M')
hist_genM.SetDirectory(0)

hist_recA = input_file.Get('fHistRecSingle_A')
hist_recA.SetDirectory(0)
hist_recM = input_file.Get('fHistRecSingle_M')
hist_recM.SetDirectory(0)

hist_genA.Add(hist_genM)
hist_gen = hist_genA
hist_gen.SetDirectory(0)
hist_gen.SetName('generated')
hist_recA.Add(hist_recM)
hist_rec = hist_recA
hist_rec.SetDirectory(0)
hist_rec.SetName('reconstructed')
...
output_file = TFile('~/3body_workspace/preseleff_study/eff_ref.root', 'recreate')
