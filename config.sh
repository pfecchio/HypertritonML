...
if [ $BODY_2 -eq 1 ]; then    
      ...
      [ ! -f "$HYPERML_DATA_2/HyperTritonTree_18qLS.root" ] && alien_cp /alice/cern.ch/user/f/fmazzasc/splines_trees/HyperTritonTree_18qLS.root file://$HYPERML_DATA_2/HyperTritonTree_18qLS.root
      [ ! -f "$HYPERML_DATA_2/HyperTritonTree_18rLS.root" ] && alien_cp /alice/cern.ch/user/f/fmazzasc/splines_trees/HyperTritonTree_18rLS.root file://$HYPERML_DATA_2/HyperTritonTree_18rLS.root
