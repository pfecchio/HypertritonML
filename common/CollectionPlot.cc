...
void CollectionPlot()
{
  ...
  std::string names[nMeasures] {"PR 136 (1964) B1803", "PRL 20 (1968) 819", "PR 180 (1969) 1307", "NPB 16 (1970) 46", "PRD 1 (1970) 66", "NPB 67 (1973) 269", "Science 328 (2010) 58", "NPA 913 (2013) 170", "PLB 754 (2016) 360", "PRC 97 (2018) 054909", "PLB 797 (2019) 134905"};
  if (kWOPrel == false)
  ...
  gSpect_alice->SetMarkerStyle(47);
  gSpect_alice->SetMarkerSize(1.4);
