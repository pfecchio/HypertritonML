...
{
  TFile *myFile = TFile::Open("../../../HypertritonAnalysis/Trees/HyperTritonTree_18r.root", "r");
  ...
  TFile tfile("../../../HypertritonAnalysis/Derived_Trees/HyperTree_Data.root", "RECREATE");
