...
void HyperTreeFatherMC(bool fRejec = true)
{
    ...
    TFile *myFile = TFile::Open("../../../HypertritonAnalysis/Trees/HyperTritonTree_19d2.root", "r");
    ...
    TFile tfile("~/HypertritonAnalysis/Derived_Trees/HyperTree_MC_Signal.root", "RECREATE");
