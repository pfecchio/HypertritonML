...
void HyperTreeFatherBkgMC(TString name = "HyperTritonTree_19d2.root")
{
  ...
  TFile tableFile(Form("%s/BkgTable.root", tableDir), "RECREATE");
  Table outputTable("BkgTable", "Bkg table");
